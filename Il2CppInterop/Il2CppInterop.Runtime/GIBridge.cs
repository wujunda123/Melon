...
namespace Il2CppInterop.Runtime
{
    static unsafe class GIBridge
    {
        ...
        public static _il2cpp_assembly_get_image il2cpp_assembly_get_image = GetDelegate<_il2cpp_assembly_get_image>(0x91EA20);
        public static _il2cpp_class_from_name il2cpp_class_from_name = GetDelegate<_il2cpp_class_from_name>(0x915E10);
        public static _il2cpp_class_get_method_from_name il2cpp_class_get_method_from_name = GetDelegate<_il2cpp_class_get_method_from_name>(0x91F820);
        public static _il2cpp_class_get_methods il2cpp_class_get_methods = GetDelegate<_il2cpp_class_get_methods>(0x9202C0);
        public static _il2cpp_runtime_invoke_convert_args il2cpp_runtime_invoke_convert_args = GetDelegate<_il2cpp_runtime_invoke_convert_args>(0x8D6D10);
        public static _il2cpp_runtime_invoke il2cpp_runtime_invoke = GetDelegate<_il2cpp_runtime_invoke>(0x8D6CF0);
        public static _il2cpp_value_box il2cpp_value_box = GetDelegate<_il2cpp_value_box>(0x9156E0);
        public static _il2cpp_string_new il2cpp_string_new = GetDelegate<_il2cpp_string_new>(0x92E1F0);
        public static _il2cpp_string_new_utf16 il2cpp_string_new_utf16 = GetDelegate<_il2cpp_string_new_utf16>(0x92E880);
        public static _il2cpp_method_get_name il2cpp_method_get_name = GetDelegate<_il2cpp_method_get_name>(0x91FC20);
        public static _il2cpp_object_new il2cpp_object_new = GetDelegate<_il2cpp_object_new>(0x92E270);
        public static _il2cpp_object_get_virtual_method il2cpp_object_get_virtual_method = GetDelegate<_il2cpp_object_get_virtual_method>(0x9252C0);
        public static _il2cpp_class_from_type il2cpp_class_from_type = GetDelegate<_il2cpp_class_from_type>(0x918900);
        public static _il2cpp_field_static_get_value il2cpp_field_static_get_value = GetDelegate<_il2cpp_field_static_get_value>(0x935C90);
        public static _il2cpp_domain_get il2cpp_domain_get = GetDelegate<_il2cpp_domain_get>(0x91C050);

        public static _il2cpp_gchandle_new il2cpp_gchandle_new = GetDelegate<_il2cpp_gchandle_new>(0x9E4850);
        public static _il2cpp_gchandle_get_target il2cpp_gchandle_get_target = GetDelegate<_il2cpp_gchandle_get_target>(0x9E4530);
        public static _il2cpp_gchandle_free il2cpp_gchandle_free = GetDelegate<_il2cpp_gchandle_free>(0x9E41E0);

        public static _Assembly_Load Assembly_Load = GetDelegate<_Assembly_Load>(0x92C7B0);
        public static _Reflection_GetModuleObject Reflection_GetModuleObject = GetDelegate<_Reflection_GetModuleObject>(0x920390);
        public static _Reflection_GetTypeObject Reflection_GetTypeObject = GetDelegate<_Reflection_GetTypeObject>(0x924700);
        public static _Reflection_GetFieldObject Reflection_GetFieldObject = GetDelegate<_Reflection_GetFieldObject>(0x8FD490);
        public static _il2cpp_method_get_object il2cpp_method_get_object = GetDelegate<_il2cpp_method_get_object>(0x91FD00);
    }
}
