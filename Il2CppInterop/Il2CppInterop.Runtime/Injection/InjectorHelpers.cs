...
namespace Il2CppInterop.Runtime.Injection
{
    internal static unsafe class InjectorHelpers
    {
        ...
        internal static ProcessModule Il2CppModule = null;//Process.GetCurrentProcess()
        ...
        private static IntPtr classFromType = Il2CppHandle + 0x9285D0;
        private static IntPtr getTypeInfoFromTypeDefinitionIndex = Il2CppHandle + 0x933BA0;
        private static IntPtr classFromName = Il2CppHandle + 0x925B90;
        private static IntPtr getMBMethods = Il2CppHandle + 0x92E900;
        ...
        internal delegate void d_GetMBMethods(Il2CppClass* _class, IntPtr* ptrs, IntPtr* names, int n);
        private static void hkGetMBMethods(Il2CppClass* _class, IntPtr* ptrs, IntPtr* names, int n)
        {
            if (RuntimeSpecificsStore.IsInjected((IntPtr)_class))
            {
                for (var i = 0; i < n; i++)
                {
                    ptrs[i] = IL2CPP.il2cpp_class_get_method_from_name((IntPtr)_class, Marshal.PtrToStringAnsi(names[i]), 0);
                }
            }
            else
            {
                GetMBMethodsOriginal(_class, ptrs, names, n);
            }
        }

        private static readonly d_GetMBMethods GetMBMethodsDetour = new(hkGetMBMethods);
        internal static d_GetMBMethods GetMBMethods;
